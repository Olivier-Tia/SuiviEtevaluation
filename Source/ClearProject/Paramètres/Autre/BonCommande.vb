...
Public Class BonCommande
    ...
    Private Sub Chargertiers()
        ...
        For Each rw2 As DataRow In dt2.Rows
            Cmbct.Properties.Items.Add(rw2(1).ToString + "   " + MettreApost(rw2(3).ToString))
        Next
    End Sub
    ...
    Private Sub TxtPu_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles TxtPu.KeyPress
    ...
    Private Sub TxtPu_TextChanged(sender As System.Object, e As System.EventArgs) Handles TxtPu.TextChanged
    ...
    Private Sub TxtQte_TextChanged(sender As System.Object, e As System.EventArgs) Handles TxtQte.TextChanged
        If TxtQte.Text <> "" And TxtPu.Text <> "" Then
            Dim qte As Double = 0
            Dim pu As Double = 0
            qte = IIf(TxtQte.Text = "", 0, TxtQte.Text)
