...
Public Class Plan_tiers
    ...
    Private Sub AjoutPlanDeTiersToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AjoutPlanDeTiersToolStripMenuItem.Click
        Creer_compte_tier.Size = New Point(710, 450)
    ...
    Private Sub ModificationPlanDeTiersToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ModificationPlanDeTiersToolStripMenuItem.Click
        Try
            If (ViewCptTiers.RowCount > 0) Then
                ...
                If cpte > 3 Then
                    alert = True
                    rep = ConfirmMsg("Vous avez sélectionné plus de 3 comptes." & vbNewLine & "Voulez-vous que le système modifie les 3 premiers comptes?")
                End If
                ...
                If alert Then
                    If rep = DialogResult.No Then
                        For i = 0 To ViewCptTiers.RowCount - 1
                            If CBool(ViewCptTiers.GetRowCellValue(i, "Choix")) = True Then
                                ActiverChamps4(Modif_PlanTiers.PanelControl5)
                                EffacerTexBox5(Modif_PlanTiers.PanelControl5)
                                EffacerTexBox5(Modif_PlanTiers.PanelControl4)
                                EffacerTexBox1(Modif_PlanTiers.GroupBox1)
                                EffacerTexBox1(Modif_PlanTiers.Groupbban)
                                EffacerTexBox1(Modif_PlanTiers.Groupiban)
                                EffacerTexBox1(Modif_PlanTiers.GroupBox3)
                                EffacerTexBox1(Modif_PlanTiers.GroupBox4)
                                EffacerTexBox1(Modif_PlanTiers.Grouplocale)

                                ActiverChamps4(Modif_PlanTiers.PanelControl4)
                                ActiverChamps10(Modif_PlanTiers.GroupBox1)
                                ActiverChamps10(Modif_PlanTiers.Groupbban)
                                ActiverChamps10(Modif_PlanTiers.Grouplocale)
                                ActiverChamps10(Modif_PlanTiers.Groupiban)
                                ActiverChamps10(Modif_PlanTiers.GroupBox3)
                                ActiverChamps10(Modif_PlanTiers.GroupBox4)
                                ...
                                For Each rwx As DataRow In dt.Rows
                                    Modif_PlanTiers.txtCodeTiers.Text = ViewCptTiers.GetRowCellValue(i, "Code").ToString
                                    Modif_PlanTiers.CodeCptCahe.Text = ViewCptTiers.GetRowCellValue(i, "Code").ToString
                                    Modif_PlanTiers.cmbType.Text = rwx("Code_CL") & " | " & MettreApost(rwx("libelle_tcpt").ToString)
                                    Modif_PlanTiers.Txtabr.Text = rwx(1).ToString
                                    Modif_PlanTiers.txtIntitule.Text = MettreApost(rwx(2).ToString)
                                    Modif_PlanTiers.txtadresse.Text = MettreApost(rwx(3).ToString)
                                    Modif_PlanTiers.txtcontact.Text = rwx(4).ToString
                                    Modif_PlanTiers.txtmail.Text = MettreApost(rwx(5).ToString)
                                    Modif_PlanTiers.Txtrc.Text = rwx(6).ToString
                                    Modif_PlanTiers.Txtcc.Text = rwx(7).ToString
                                    Modif_PlanTiers.Txttel.Text = rwx(8).ToString
                                    Modif_PlanTiers.Txtfax.Text = rwx(9).ToString
                                    Modif_PlanTiers.Txtsite.Text = MettreApost(rwx(10).ToString)
                                    Modif_PlanTiers.Txtqualite.Text = rwx(11).ToString
                                Next



                                query = "select z.libellezone from t_zonegeo z,t_comp_compte c where z.codezone=c.code_v and c.code_cpt='" + ViewCptTiers.GetRowCellValue(i, "Code").ToString + "' and c.code_projet='" + ProjetEnCours + "'"
                                dt = ExcecuteSelectQuery(query)
                                For Each rwx As DataRow In dt.Rows
                                    Modif_PlanTiers.Combville.Text = MettreApost(rwx(0).ToString)
                                Next
                                ...
                                dt = ExcecuteSelectQuery(query)
                                For Each rwx As DataRow In dt.Rows
                                    Modif_PlanTiers.Combsc.Text = rwx(0).ToString + "   " + MettreApost(rwx(1).ToString)
                                Next
                                ...
                                Next
                                Modif_PlanTiers.LgListContact.DataSource = dtcontact

                                Modif_PlanTiers.ViewContact.Columns(0).Width = 150
                                Modif_PlanTiers.ViewContact.Columns(1).Width = 150
                                Modif_PlanTiers.ViewContact.Columns(2).Width = 100
                                Modif_PlanTiers.ViewContact.Columns(3).Width = 150
                                Modif_PlanTiers.ViewContact.Columns(4).Width = 150
                                Modif_PlanTiers.ViewContact.Columns(5).Width = 100
                                Modif_PlanTiers.ViewContact.Columns(6).Width = 100


                                query = "select b.codebanq,b.ribbanq,b.devisebanq from t_comp_banque b, t_comp_rattach_banq rb where b.ribbanq=rb.ribbanq and rb.code_cpt='" + ViewCptTiers.GetRowCellValue(i, "Code").ToString + "' and code_projet='" + ProjetEnCours + "'"
                                dt = ExcecuteSelectQuery(query)
                                For Each rwx As DataRow In dt.Rows
                                    Dim drS = dtBanque.NewRow()
                                    drS(0) = rwx(0).ToString
                                    drS(1) = rwx(1).ToString
                                    drS(2) = rwx(2).ToString
                                    dtBanque.Rows.Add(drS)
                                Next
                                Modif_PlanTiers.LgListBanque.DataSource = dtBanque


                                Modif_PlanTiers.GridView1.Columns(0).Width = 300
                                Modif_PlanTiers.GridView1.Columns(1).Width = 300
                                Modif_PlanTiers.GridView1.Columns(2).Width = 300
                                ...
                                For Each rwx As DataRow In dt.Rows
                                    ...
                                    Next
                                Next
                                Modif_PlanTiers.LgListCumul.DataSource = dtcumuls


                                Modif_PlanTiers.ViewCumul.Columns(0).Width = 110
                                Modif_PlanTiers.ViewCumul.Columns(1).Width = 140
                                Modif_PlanTiers.ViewCumul.Columns(2).Width = 140
                                Modif_PlanTiers.ViewCumul.Columns(3).Width = 140
                                Modif_PlanTiers.ViewCumul.Columns(4).Width = 140

                                Modif_PlanTiers.LabelControl34.Text = 0
                                Modif_PlanTiers.LabelControl35.Text = 0
                                Modif_PlanTiers.LabelControl36.Text = 0
                                Modif_PlanTiers.LabelControl37.Text = 0

                                For m = 0 To Modif_PlanTiers.ViewCumul.RowCount - 1
                                    Modif_PlanTiers.LabelControl34.Text = AfficherMonnaie(CInt(Modif_PlanTiers.LabelControl34.Text) + CInt(dtcumuls.rows(m).item(1)))
                                    Modif_PlanTiers.LabelControl35.Text = AfficherMonnaie(CInt(Modif_PlanTiers.LabelControl35.Text) + CInt(dtcumuls.rows(m).item(2)))
                                    Modif_PlanTiers.LabelControl36.Text = AfficherMonnaie(CInt(Modif_PlanTiers.LabelControl36.Text) + CInt(dtcumuls.rows(m).item(3)))
                                    Modif_PlanTiers.LabelControl37.Text = AfficherMonnaie(CInt(Modif_PlanTiers.LabelControl37.Text) + CInt(dtcumuls.rows(m).item(4)))
                                Next

                                Modif_PlanTiers.Size = New Point(710, 450)
                                Dialog_form(Modif_PlanTiers)
                            End If
