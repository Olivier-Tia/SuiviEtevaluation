...
Public Class ClearMdi
    ...
    Private Sub NavRSM_LinkClicked(ByVal sender As Object, ByVal e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles NavRSM.LinkClicked
    ...
    Private Sub BarItineraireCourrier_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarItineraireCourrier.ItemClick
        Dialog_form(Courrier_TypeEtItineraire)
    End Sub
    ...
    Private Sub xNavRPB_LinkClicked(ByVal sender As Object, ByVal e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles fNavRSF.LinkClicked
    ...
    Private Sub NavRSF_LinkClicked(ByVal sender As Object, ByVal e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles NavRSF.LinkClicked
        Disposer_form(RapportSuiviFinancierClear)
        FinChargement()
    End Sub

    Private Sub NavRAP_LinkClicked(ByVal sender As Object, ByVal e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles NavRAP.LinkClicked
        Disposer_form(RapportActiviteClear)
        FinChargement()
    End Sub

    Private Sub NavRapGlob_LinkClicked(ByVal sender As Object, ByVal e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles NavRapGlob.LinkClicked
    ...
    Private Sub Timer1_Tick(sender As System.Object, e As System.EventArgs) Handles Timer1.Tick
        Actualisation()
    End Sub
    Private Sub BarTypeMat_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarTypeMat.ItemClick
        Dialog_form(ParametreTypeMateriel)
        'parametre = "Type de matériel"
        'paramètre.GroupControl1.Text = parametre
        'Dialog_form(paramètre)
    End Sub

    Private Sub BarMarque_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarMarque.ItemClick
        Dialog_form(ParametreMarque)
        'parametre = "Marque"
        'paramètre.GroupControl1.Text = parametre
        'Dialog_form(paramètre)
    End Sub

    Private Sub BarSourceE_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarSourceE.ItemClick
        Dialog_form(Add_Carburant)
        'parametre = "Source d'énergie"
        'paramètre.GroupControl1.Text = parametre
        'Dialog_form(paramètre)
    End Sub

    Private Sub BarCouleur_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarCouleur.ItemClick
        Dialog_form(ParametreCouleur)
        'parametre = "Couleur"
        'paramètre.GroupControl1.Text = parametre
        'Dialog_form(paramètre)
    End Sub
