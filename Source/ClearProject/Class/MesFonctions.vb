...
Module CONNEXION
    ...
    Sub remplirDataGridBoncommande(ByVal requete As String, ByVal mondg As DevExpress.XtraGrid.GridControl, ByVal nbre As DevExpress.XtraEditors.LabelControl, ByVal grid As DevExpress.XtraGrid.Views.Grid.GridView)
        Try
            ...
            For Each rw As DataRow In dt.Rows
                ...
                drS(5) = rw(4).ToString
                drS(6) = ""
                drS(7) = AfficherMonnaie(Round(CDbl(rw(6).ToString)))
                dtimmo.Rows.Add(drS)
            Next
    ...
    Public Sub VerifSaisieMontant(ByRef Zone As Object)
        ...
        Try
            ...
            If (Zone.Text = "NL" Or Zone.Text = "TM") Then
            Else
                If (Zone.Text <> "") Then
                    ...
                    Else
                        MsgBox("Vous avez tapé un caractère non autorisé!", MsgBoxStyle.Information)
    ...
    Function ChargerFacture(ByVal monbt As DevExpress.XtraEditors.SimpleButton, ByVal opdg As OpenFileDialog, ByVal lab As Label)
        Try
            If (opdg.ShowDialog() = DialogResult.OK) Then
                Dim monfichier As String = opdg.FileName
                Dim ext As String
                ext = New System.IO.FileInfo(monfichier).Extension.ToLower()
                If ext = ".jpg" Or ext = ".JPG" Or ext = ".png" Or ext = ".jpeg" Or ext = ".JPEG" Or ext = ".pdf" Then
                    Dim i = 0
                    Dim t = 0
                    For i = 0 To Len(monfichier) - 1
                        If monfichier(i).ToString = "\" Then
                            t = i
                        End If
                    Next
                    monbt.Text = ExtraireNom(monfichier)
                    monbt.ForeColor = Color.Red
                    lab.Enabled = True
                    Return monfichier
                Else
                    SuccesMsg("Veillez choisir un fichier image ou pdf")
                End If
            End If
        Catch ex As Exception
            FailMsg("Erreur : Information non disponible : " & ex.ToString())
    ...
    Function ChargerFacture4(ByVal monbt As DevExpress.XtraEditors.TextEdit, ByVal opdg As OpenFileDialog)
        Try
            Dim monfichier = ""
            opdg.ShowDialog()
            monfichier = opdg.FileName
            If monfichier <> "OpenFileDialog1" Then
                Dim ext As String
                ext = New System.IO.FileInfo(monfichier).Extension
                If ext = ".jpg" Or ext = ".JPG" Or ext = ".png" Or ext = ".jpeg" Or ext = ".JPEG" Or ext = ".pdf" Or ext = ".PDF" Or ext = ".docx" Or ext = ".xlsx" Or ext = ".XLSX" Or ext = ".DOCX" Or ext = ".DOC" Or ext = ".doc" Then
                    Dim i = 0
                    Dim t = 0
                    For i = 0 To Len(monfichier) - 1
                        If monfichier(i).ToString = "\" Then
                    ...
                    Return monfichier
                Else
                    MsgBox("Veillez choisir un fichier image ou pdf")
                End If
            End If
        Catch ex As Exception
            FailMsg("Erreur : Information non disponible : " & ex.ToString())
    ...
    Sub ModifParam2(ByVal matable As String, ByVal idlibelle As DevExpress.XtraEditors.TextEdit, ByVal libelle As DevExpress.XtraEditors.TextEdit)
        Try
            ...
            query = "UPDATE " + matable + " SET " + colonneTab(0) + " = '" + EnleverApost(libelle.Text) + "' WHERE " + colonneTab(1) + " = '" + idlibelle.Text + "'"
            ExecuteNonQuery(query)
...
Erreur:
    ...
    Function ChargerFichier(ByVal monbt As DevExpress.XtraEditors.SimpleButton, ByVal opdg As OpenFileDialog, ByVal lab As Label)

        Dim monfichier = ""
        opdg.ShowDialog()
        monfichier = opdg.FileName

        If monfichier <> "" And monfichier <> " " Then
            Dim ext As String
            ext = New System.IO.FileInfo(monfichier).Extension
            If ext = ".jpg" Or ext = ".JPG" Or ext = ".png" Or ext = ".jpeg" Or ext = ".JPEG" Or ext = ".docx" Or ext = ".doc" Or ext = ".pdf" Then
                Dim CheminFichier = monfichier
                monbt.Text = ExtraireNom(CheminFichier)
                monbt.ForeColor = Color.Red
                lab.Enabled = True
                Return monfichier
            Else
                MsgBox("Veillez choisir un fichier word, pdf ou image")
            End If
        End If
    ...
    Function ChargerFacture2(ByVal List As ListBox, ByVal List1 As ListBox, ByVal opdg As OpenFileDialog, ByVal lab As Label)
        Try
            Dim monfichier = ""
            opdg.ShowDialog()
            monfichier = opdg.FileName
            If monfichier <> "OpenFileDialog1" Then
                ...
                If ext = ".jpg" Or ext = ".JPG" Or ext = ".png" Or ext = ".jpeg" Or ext = ".JPEG" Or ext = ".pdf" Then
                    ...
                    For i = 0 To Len(monfichier) - 1
                        ...
                        End If
                    Next
                    List.Items.Add(ExtraireNom(monfichier))
                    List1.Items.Add(monfichier)
                    lab.Enabled = True
                    Return monfichier
                Else
                    MsgBox("Veillez choisir un fichier image ou pdf")
    ...
    Function ChargerFacture3(ByVal List As DevExpress.XtraEditors.ListBoxControl, ByVal List1 As ListBox, ByVal opdg As OpenFileDialog, ByVal lab As Label)
        Try
            Dim monfichier = ""
            opdg.ShowDialog()
            monfichier = opdg.FileName
            If monfichier <> "OpenFileDialog1" Then
                Dim ext As String
                ext = New System.IO.FileInfo(monfichier).Extension
                If ext = ".jpg" Or ext = ".JPG" Or ext = ".png" Or ext = ".PNG" Or ext = ".jpeg" Or ext = ".JPEG" Or ext = ".pdf" Or ext = ".doc" Or ext = ".docx" Or ext = ".xls" Or ext = ".xlsx" Then
                    Dim i = 0
                    Dim t = 0
                    For i = 0 To Len(monfichier) - 1
                        If monfichier(i).ToString = "\" Then
    ...
    Sub remplirDataGridCateg(ByVal mondg As DevExpress.XtraGrid.GridControl, ByVal grid As DevExpress.XtraGrid.Views.Grid.GridView, ByVal requete As String)
        Try
            ...
            dtcateg.Columns.Add("Numero Catégorie", Type.GetType("System.String"))
