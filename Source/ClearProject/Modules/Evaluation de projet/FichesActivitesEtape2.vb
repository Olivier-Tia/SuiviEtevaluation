...
Public Class FichesActivitesEtape2
    ...
    Private Sub BtEnregistrer_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtEnregistrer.Click
        ...
        If (CmbCompte.Text = "") And (CmbCompte.Visible = True) Then MsgErr = " - Numero de compte"
        If (Cmbarticle.Text = "") And (Cmbarticle.Visible = True) Then MsgErr = " - Numero de l'article"
