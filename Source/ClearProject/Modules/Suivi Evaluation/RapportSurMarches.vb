...
Public Class RapportSurMarches
    ...
    Private Sub RapportSurMarches_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)  Handles MyBase.Load
    ...
    Private Sub ActivImprim()
        ...
        If (ChkDetails.Checked = True Or ChkStatistic.Checked = True Or ChkSituation.Checked = True Or ChkAttente.Checked = True Or ChkExecution.Checked = True Or ChkDAO.Checked = True Or ChkGraph.Checked = True) Then
            BtImprimerRapp.Enabled = True
        Else
            BtImprimerRapp.Enabled = False
        End If
    ...
    Private Sub ChkAttente_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkAttente.CheckedChanged
        ActivImprim()
        If (ChkAttente.Checked = True) Then
    ...
    Private Sub BtOuvrirRapp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtOuvrirRapp.Click
